              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <CardTitle className="text-base">
                    {submissionData?.user?.name?.fullName}
                  </CardTitle>
                  <CardDescription>
                ...
                <TabsContent value="rubric" className="mt-0">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid gap-2">
                      {submissionAttachments.map((attachment: any) => (
                        <div
                                ...
                                <span className="text-xs bg-green-100 text-green-800 px-2 py-0.5 rounded-full">
                                  {
                                    criterion.levels.find(
                                      (l: RubricLevel) => l.id === selectedLevels[criterion.id],
                                    )?.title
                                  }
                                </span>
                              )}
                ...
                <TabsContent value="history" className="mt-0">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {submissionData.submissionHistory.map((entry: any, index: number) => (
